...
import static mate.academy.carsharing.app.example.AuthenticationUtilTest.roleCustomer;
import static mate.academy.carsharing.app.example.AuthenticationUtilTest.roleManager;
...
public class UserUtilTest {
    ...
    public static List<UserDto> listFourUsersDto() {
        ...
        user1.setId(2L);
        user1.setEmail("veronika333@gmail.com");
        user1.setFirstName("Veronika");
        user1.setLastName("Nika");
        user1.setRolesId(List.of(2L));

        UserDto user2 = new UserDto();
        user2.setId(3L);
        user2.setEmail("max222@gmail.com");
        ...
        user3.setId(4L);
        user3.setEmail("john444@gmail.com");
        user3.setFirstName("John");
        user3.setLastName("Jo");
        user3.setRolesId(List.of(2L));
        return List.of(manager, user1, user2, user3);
    }
