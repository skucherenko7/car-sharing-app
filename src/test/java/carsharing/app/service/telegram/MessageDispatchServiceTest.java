...
import carsharing.app.CarSharingAppApplication;
...
class MessageDispatchServiceTest {
    ...
    @Test
    @DisplayName("SentMessageToManagerNotOverdue: sends manager "
            + "not overdue message without exception")
    ...
    void sendMessage_shouldThrowIfNoTelegramChatId() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> messageDispatchService.sendMessage(user.getId(), "Hello"));
    }
    ...
    void sendMessage_shouldThrowIfUserNotFound() {
        assertThrows(MessageDispatchException.class,
                () -> messageDispatchService.sendMessage(99999L, "Hello"));
    }
    ...
    void sendMessage_shouldThrowOnRestClientException() {
        ...
        assertThrows(MessageDispatchException.class,
                () -> serviceWithMock.sendMessage(user.getId(), "Hello"));
    }
}
